...
Governing AI output the way a bank governs risk data — **schema**, **lineage**, and
**governance controls**. An AI output is just another data element with poor lineage by
default; this project holds it to the same questions a bank asks of any risk number.

> A readable guided tour of the design. Source repo:
> [VincentChong123/euc-ai-governance](https://github.com/VincentChong123/euc-ai-governance).
...
- **Contract at key boundaries** → schema-contract onboarding (BCBS 239 P2).
- **Provenance on material outputs** → reconstruct and defend any number (BCBS 239 P7).
